...
import { Loader2, Eye, EyeOff, CheckCircle2, ArrowRight, ShieldAlert } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        {!token ? (
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-10 text-center shadow-card animate-scale-in">
            ...
            <h2 className="text-2xl font-black text-slate-900 mb-2 tracking-tight">Password reset!</h2>
            <p className="text-slate-500 text-sm mb-8 leading-relaxed">
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-card">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-100 px-4 py-3">
                <p className="text-xs font-semibold text-slate-500 mb-1.5">Strong passwords include:</p>
                <ul className="space-y-0.5">
                  {[
                    ...
                    <li key={label as string} className={`flex items-center gap-2 text-xs ${met ? 'text-emerald-600' : 'text-slate-400'}`}>
              ...
              <button
                ...
                className="btn-primary w-full justify-center py-3 shadow-glow-sm mt-2"
              >
            ...
            <div className="mt-6 text-center">
              <Link href="/auth/forgot-password" className="text-sm text-slate-400 hover:text-slate-600 transition-colors">
                Need a new link?
              </Link>
            </div>
          </div>
